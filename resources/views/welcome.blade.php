...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="bg-white p-6 rounded-lg shadow-md w-full max-w-md">
        ...
        <div class="w-full">
            <img src="{{ url('assets/img/logo.svg') }}" alt="eCitizen Logo" class="w-full">
        </div>
        ...
        <form action="{{ url('/login') }}" method="POST" class="mt-5">
            ...
            <div class="relative">
                ...
                <button type="button" class="absolute right-3 top-3 text-gray-600" @click="showPassword = !showPassword"> 👁 </button>
            </div>
            ...
            <button type="submit" class="w-full bg-green-600 text-white py-2 rounded-lg mt-5 hover:bg-green-700"> Sign In </button>
